...
> 📅 本清单核验时间：**2026-09-13**。欢迎提 Issue / PR 更新失效信息。也欢迎提供未收录的公益站点~
...
| 维云模型开放平台 | https://vsllm.cc/i/z2IN 或https://vsllm.com/i/z2IN | 每日任务获取免费额度 | Claude / GPT / Glm / Deepseek 等69个模型 | 注册无限制 |
...
| CM-API-公益站 | https://api.chengmo.cc.cd/sign-up?aff=lz0Q | 每日签到获取免费额度 | Claude / GPT / Glm / Deepseek 等46个模型 | 注册无限制 |
